...
> 這個資料夾現在也跑在 GitHub Actions 雲端排程(`.github/workflows/news-crawler.yml`,
> 每天 08:00 / 20:00 台灣時間),設定方式見主目錄 [README.md](../README.md#雲端自動化github-actions)。
> 下面的 `run.bat` + 工作排程器是本機備援方案,兩者可以並存但沒必要同時開,
> 免得同一天寄兩次信、`news.db` 互相追著跑。
